...
contract TransferOINROwnership is Script {
    address constant OLD_VAULT_MANAGER =
        0x2241e8cC49b20fd631C7Cf5810fd87DB78AAe97e;
    address constant NEW_VAULT_MANAGER =
        0x22E1AE8A85e76e94683D668c0107b69eF18a62cA;
    ...
    function run() external {
        ...
        if (currentOwner == OLD_VAULT_MANAGER) {
            ...
            try
                IVaultManager(OLD_VAULT_MANAGER).transferTokenOwnership(
                    OINR_TOKEN,
                    NEW_VAULT_MANAGER
                )
            {
                ...
                console.log(
                    "[FAILED] Old VaultManager doesn't have transferTokenOwnership"
                );
                console.log(
            ...
            console.log(
                "WARNING: oINR owned by unexpected address:",
                currentOwner
            );
